    ...
    async createTicket(request) {
        ...
        if (this.verbose) {
            ...
            console.log('FormData contains:', {
                ...
                files: (_a = request.attachments) === null || _a === void 0 ? void 0 : _a.map(f => (typeof f === 'string' ? f : f.name))
            });
        }
        else {
            console.log(`📤 POST /v3/tickets/create_with_attachment (${((_b = request.attachments) === null || _b === void 0 ? void 0 : _b.length) || 0} file(s))`);
        }
        try {
